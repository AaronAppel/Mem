...
struct ImFont
{
    ...
    ImVector<float>             IndexAdvanceX;      //              // Sparse. Glyphs->AdvanceX in a directly indexable way (more cache-fristd::endly, for CalcTextSize functions which are often bottleneck in large UI).
